...
data = [
    ...
    89, 89, 75, 66, 45, 59, 71, 89, 76, 74, 86, 56, 44, 91, 62, 75, 86, 81, 76, 65, 55, 55, 55, 55, 55, 71, 71, 71, 71, 71, 79, 79, 79, 79, 79, 79, 47, 47, 47, 47, 47, 47
]
...
def printTable(tableF):
    ...
    for fila in tableF:
        ...
        print(f"{interval:<20}{fi:<10}{fa:<10}{fsr:<10}{far:<10}"
              f"{xi:<10}{fixi:<15}{fixi2:<15}{round(percFsr, 2):<10}{percFar:<10}")
